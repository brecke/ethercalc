...
(function() {
  ...
  this.include = function() {
    ...
    hmac = !KEY
      ...
      : function(it) {
          ...
          return (
            HMAC_CACHE[it] ||
            (HMAC_CACHE[it] =
              ((encoder = require('crypto').createHmac(
                'sha256',
                new Buffer(KEY),
              )),
    ...
    (ref$ = ['text/plain', 'text/html', 'text/csv', 'application/json'].map(
      function(it) {
    ...
    env = process.env;
    (ref$ = [env['REDIS_PORT'], env['REDIS_HOST']]),
      (redisPort = ref$[0]),
      (redisHost = ref$[1]);
    ...
    if (this.CORS) {
      ...
      this.all('*', function(req, res, next) {
        ...
        this.response.header(
          ...
          'X-Requested-With,Content-Type,If-Modified-Since',
        );
    ...
    newRoom = function() {
      return require('uuid-pure')
        .newId(12, 36)
        .toLowerCase();
    };
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/'] = sendFile('index.html')), ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/etc/*'] = function() {
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/favicon.ico'] = sendFile('favicon.ico')),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/android-chrome-192x192.png'] = sendFile(
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/apple-touch-icon.png'] = sendFile(
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/browserconfig.xml'] = sendFile('browserconfig.xml')),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/favicon-16x16.png'] = sendFile('favicon-16x16.png')),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/favicon-32x32.png'] = sendFile('favicon-32x32.png')),
      ref$),
    );
    this.get(
      ((ref$ = {}),
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/mstile-150x150.png'] = sendFile('mstile-150x150.png')),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/mstile-310x310.png'] = sendFile('mstile-310x310.png')),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/safari-pinned-tab.svg'] = sendFile(
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/manifest.appcache'] = function() {
    ...
    if (
      fs.existsSync(RealBin + '/node_modules/socialcalc/dist/SocialCalc.js')
    ) {
      this.get(
        ((ref$ = {}),
        (ref$[BASEPATH + '/static/socialcalc.js'] = function() {
          this.response.type('application/javascript');
          return this.response.sendfile(
            RealBin + '/node_modules/socialcalc/dist/SocialCalc.js',
          );
        }),
        ref$),
      );
    } else if (
      fs.existsSync(RealBin + '/node_modules/socialcalc/SocialCalc.js')
    ) {
      this.get(
        ((ref$ = {}),
        (ref$[BASEPATH + '/static/socialcalc.js'] = function() {
          this.response.type('application/javascript');
          return this.response.sendfile(
            RealBin + '/node_modules/socialcalc/SocialCalc.js',
          );
        }),
        ref$),
      );
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/static/form:part.js'] = function() {
        var part;
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/=_new'] = function() {
        var room;
        room = newRoom();
        return this.response.redirect(
          KEY ? BASEPATH + '/=' + room + '/edit' : BASEPATH + '/=' + room,
        );
      }),
      ref$),
    );
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_start'] = sendFile('start.html')),
      ref$),
    );
    IO = this.io;
      ...
      return function() {
        ...
        if (/^%3D/.exec(room) && cbMultiple) {
                ...
                return csvParse(
                  ...
                  function(_, body) {
                    ...
                    return todo.exec(function(_, saves) {
                      var ref$, type, content, ext;
                      (ref$ = cbMultiple.call(this$.params, names, saves)),
                        (type = ref$[0]),
                        (content = ref$[1]),
                        (ext = ref$[2]);
                      this$.response.type(type);
          ...
          return SC._get(room, IO, function(arg$) {
            ...
            snapshot = arg$.snapshot;
            if (snapshot) {
              (ref$ = cb.call(this$.params, snapshot)),
                (type = ref$[0]),
                (content = ref$[1]);
              if (type === Csv) {
                this$.response.set(
                  'Content-Disposition',
                  'attachment; filename="' + this$.params.room + '.csv"',
                );
              }
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_timetrigger'] = function() {
        var this$ = this;
        return DB.hgetall('cron-list', function(arg$, allTimeTriggers) {
          ...
          for (cellID in allTimeTriggers) {
            ...
            res$ = [];
            for (
              i$ = 0, len$ = (ref$ = timeList.split(',')).length;
              i$ < len$;
              ++i$
            ) {
              ...
              if (triggerTimeMins <= timeNowMins) {
                (ref1$ = cellID.split('!')),
                  ...
                  (cell = ref1$[1]);
                console.log(
                  'cellID ' + cellID + ' triggerTimeMins ' + triggerTimeMins,
                );
                SC._get(room, IO, fn$);
                continue;
              } else {
    ...
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/:room.csv.json'] = ExportCSVJSON), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/:room.html'] = ExportHTML), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/:room.ods'] = ExportJ('ods')), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/:room.fods'] = ExportJ('fods')), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/:room.xlsx'] = ExportJ('xlsx')), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/:room.md'] = ExportJ('md')), ref$),
    );
    if (this.CORS) {
      this.get(
        ((ref$ = {}),
        (ref$[BASEPATH + '/_rooms'] = function() {
          this.response.type(Text);
    ...
    if (this.CORS) {
      this.get(
        ((ref$ = {}),
        (ref$[BASEPATH + '/_roomlinks'] = function() {
          this.response.type(Text);
    ...
    if (this.CORS) {
      this.get(
        ((ref$ = {}),
        (ref$[BASEPATH + '/_roomtimes'] = function() {
          this.response.type(Text);
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_from/:template'] = function() {
        var room,
          template,
          this$ = this;
        room = newRoom();
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_exists/:room'] = function() {
        var this$ = this;
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/:room'] = function() {
        var uiFile, ref$;
        uiFile = /^=/.exec(this.params.room)
          ? 'multi/index.html'
          : 'index.html';
        if (KEY) {
          if ((ref$ = this.query.auth) != null && ref$.length) {
            ...
            return this.response.redirect(
              BASEPATH + '/' + this.params.room + '?auth=0',
            );
          }
        } else {
          return sendFile(uiFile).call(this);
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/:template/form'] = function() {
        var template,
          room,
          this$ = this;
        template = this.params.template;
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/:template/appeditor'] = sendFile('panels.html')),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/:room/edit'] = function() {
        var room;
        room = this.params.room;
        return this.response.redirect(
          BASEPATH + '/' + room + '?auth=' + hmac(room),
        );
      }),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/:room/view'] = function() {
        var room;
        room = this.params.room;
        return this.response.redirect(
          BASEPATH + '/' + room + '?auth=' + hmac(room) + '&view=1',
        );
      }),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/:room/app'] = function() {
        var room;
        room = this.params.room;
        return this.response.redirect(
          BASEPATH + '/' + room + '?auth=' + hmac(room) + '&app=1',
        );
      }),
      ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_/:room/cells/:cell'] = api(function() {
        var this$ = this;
        return [
          Json,
          function(sc, cb) {
    ...
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_/:room/cells'] = api(function() {
        return [
          Json,
          function(sc, cb) {
    ...
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/_/:room/html'] = ExportHTML), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/_/:room/csv'] = ExportCSV), ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_/:room/csv.json'] = ExportCSVJSON),
      ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/_/:room/ods'] = ExportJ('ods')), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/_/:room/fods'] = ExportJ('fods')), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/_/:room/xlsx'] = ExportJ('xlsx')), ref$),
    );
    this.get(
      ((ref$ = {}), (ref$[BASEPATH + '/_/:room/md'] = ExportJ('md')), ref$),
    );
    this.get(
      ((ref$ = {}),
      (ref$[BASEPATH + '/_/:room'] = api(function(it) {
        return [Text, it];
      })),
      ref$),
    );
                ...
                .exec(function(_, arg$) {
                  ...
                  if (snapshot) {
                    ...
                    matches = snapshot.match(
                      new RegExp('cell:' + sheetId + ':t:/(.+)\n', 'i'),
                    );
                    if (matches) {
                      removeKey = matches[1];
                      backupKey = matches[1] + '.bak';
                      return DB.multi()
                        .del('snapshot-' + backupKey)
                        .rename(
                          'snapshot-' + removeKey,
                          'snapshot-' + backupKey,
                        )
                        .del('log-' + backupKey)
                        .rename('log-' + removeKey, 'log-' + backupKey)
                        .del('audit-' + backupKey)
                        .rename('audit-' + removeKey, 'audit-' + backupKey)
                        .bgsave()
                        .exec(function(_) {});
                    }
                  }
    ...
    this.post({
      '/_': function() {
        ...
        return requestToSave(this.request, function(snapshot) {
          var room, ref$;
          room =
            ((ref$ = this$.body) != null ? ref$.room : void 8) || newRoom();
          return SC._put(room, snapshot, function() {
            this$.response.type(Text);
    ...
    this.on({
      disconnect: function() {
        ...
        id = this.socket.id;
        if (
          ((ref$ = IO.sockets.manager) != null ? ref$.roomClients : void 8) !=
          null
        ) {
          CleanRoomLegacy: for (key in IO.sockets.manager.roomClients[id]) {
            if (/^\/log-/.exec(key)) {
              for (
                i$ = 0,
                  len$ = (ref1$ = IO.sockets.clients(key.substr(1))).length;
                i$ < len$;
                ++i$
              ) {
                client = ref1$[i$];
      ...
      data: function() {
        ...
        broadcast = function(data) {
          this$.socket.broadcast
            .to(this$.data.to ? 'user-' + this$.data.to : 'log-' + data.room)
            .emit('data', data);
        ...
        switch (type) {
          ...
          case 'execute':
            ...
            if (
              /^set sheet defaulttextvalueformat text-wiki\s*$/.exec(cmdstr)
            ) {
              return;
            }
            DB.multi()
              ...
              .exec(function() {
                ...
                if (commandParameters[0].trim() === 'submitform') {
                  ...
                  if (SC[room_data + ''] == null) {
                    ...
                    DB.multi()
                      .get('snapshot-' + room_data)
                      .lrange('log-' + room_data, 0, -1)
                      .exec(function(_, arg$) {
                        var snapshot, log;
                        (snapshot = arg$[0]), (log = arg$[1]);
                        return (SC[room_data + ''] = SC._init(
                          snapshot,
                          log,
                          DB,
                          room_data + '',
                  ...
                  if ((ref$ = SC[room_data + '']) != null) {
                    ref$.exportAttribs(function(attribs) {
                      ...
                      res$ = [];
                      for (
                        i$ = 0, len$ = (ref$ = commandParameters).length;
                        i$ < len$;
                        ++i$
                      ) {
                        if (i$ !== 0) {
                      ...
                      function fn$(formDataIndex, datavalue) {
                        return (
                          'set ' +
                          (String.fromCharCode(64 + formDataIndex) +
                            (attribs.lastrow + 1)) +
                          ' text t ' +
                          datavalue
                        );
          ...
          case 'stopHuddle':
            ...
            DB.del(
              ['audit', 'log', 'chat', 'ecell', 'snapshot'].map(function(it) {
                return it + '-' + room;
              }),
              function() {
                var ref$;
    ...
    function fn$() {
      ...
      return this.request.on('end', function() {
        ...
        for (k in parsed) {
          ...
          sheetsToIdx[k] = idx;
          toc +=
            '"/' + this$.params.room.replace(/"/g, '""') + '.' + idx + '",';
          toc += '"' + k.replace(/"/g, '""') + '"\n';
        ...
        function fn$(arg$, arg1$, ref) {
          return (
            "'" +
            this$.params.room.replace(/'/g, "''") +
            '.' +
            sheetsToIdx[ref.replace(/''/g, "'")] +
            "'!"
          );
        }
      });
    ...
    function eq(a, b, stack) {
      ...
      if (className == '[object Array]') {
        ...
        if (result) {
          while (size--) {
            if (
              !(result = size in a == size in b && eq(a[size], b[size], stack))
            ) {
              break;
            }
          }
